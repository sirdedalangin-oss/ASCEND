    ...
    <div className="page-shell max-w-6xl space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Upload searchable PDF, DOCX, TXT, or Markdown manuscripts. Each submission receives initial
          ratings against the five-criterion Innovation Scalability Framework. Uploaders and administrators can correct them.
          For a revised manuscript, open its existing innovation and choose Upload revision.
        </p>
      </header>
      ...
      >
        ...
        <p className="mt-1 text-xs text-muted-foreground">PDF, DOCX, TXT, or Markdown, up to 20 MB. Name the file after the manuscript title.</p>
      </Card>
