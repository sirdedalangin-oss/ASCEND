...
import { ArrowLeft, Download, CheckCircle2, XCircle, User, MapPin, Calendar } from 'lucide-react';
  ...
  return (
    <div className="page-shell max-w-6xl space-y-6">
      ...
      <Card className="p-6">
        ...
        {innovation.manuscript_file_url && (
          <Button asChild variant="outline" className="mt-4 text-sm">
            <a href={innovation.manuscript_file_url} target="_blank" rel="noopener noreferrer">
      ...
      {innovation.framework_notes && (
        <Card className="p-5"><h2 className="font-semibold text-sm mb-2">Panel notes</h2><p className="text-sm whitespace-pre-line">{innovation.framework_notes}</p></Card>
      )}
