...
class ManuscriptAnalyzer
{
    ...
    {
        return $this->analyzeWithText($input)['result'];
    }

    /**
     * @param  array{manuscript_file_url: string, original_filename?: string|null, learning_focus?: string|null, key_stage: string, grade_levels: string}  $input
     * @return array{result: array{detected_title: string, detected_learning_focus: string, summary: string}, text: string}
     */
    public function analyzeWithText(array $input): array
    {
